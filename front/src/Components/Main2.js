    ...
    return (
        <div className="container-fluid px-0">
            <nav className="navbar navbar-light ">
                <div className="container-fluid">
                    <Link className="navbar-brand ms-5 d-flex align-items-center" to='/'>
                        <img src={"empireLogo4.png"} alt="logo" width="100px" className="d-inline-block align-text-top" />
            ...
            <div className="row">
                        ...
                        >
                            <div className="row">
                                <div className="col-4 d-grid gap-2">
                                    <button className="btn btn-block btn-primary" type="button" href="/purchase">
                                        Purchase
                                    </button>
                                    <br />
                                    <button className="btn btn-block  btn-primary" type="button">
                                        <Link to='/ClosingDenomination' style={{ textDecoration: 'none', color: 'inherit' }}>Purchase Order</Link>
                                    </button>
                                    <br />
                                    <button className="btn btn-block  btn-primary" type="button">
                                        <Link to='/rds' style={{ textDecoration: 'none', color: 'inherit' }}>Purchase Return</Link>
                                    </button>
                                </div>
                                <div className="col-4 d-grid gap-2">
                                    <button className="btn btn-block  btn-primary" type="button">
                                        <Link to='/fd' style={{ textDecoration: 'none', color: 'inherit' }}>Sales Invoice</Link>
                                    </button>
                                    <br />
                                    <button className="btn btn-block  btn-primary" type="button">
                                        <Link to='/dailyreportemp' style={{ textDecoration: 'none', color: 'inherit' }}>Sales Order</Link>
                                    </button>
                                    <br />
                                    <button className="btn btn-block  btn-primary" type="button">
                                        <Link to='/rd' style={{ textDecoration: 'none', color: 'inherit' }}>Quotation</Link>
                                    </button>
                                </div>
                                <div className="col-4 d-grid gap-2">
                                    <button className="btn btn-block btn-primary" type="button">
                                    ...
                                    <br />
                                    <button className="btn btn-block  btn-primary" type="button">
                                        <Link to='/savings' style={{ textDecoration: 'none', color: 'inherit' }}>Stock List</Link>
                                    </button>
                                    <br />
                                    <button className="btn btn-block  btn-primary" type="button">
                                        <Link to='/gdcs' style={{ textDecoration: 'none', color: 'inherit' }}>Batch List</Link>
                                    </button>
                                </div>
                            </div>
                ...
                <div className="container-box col-lg-7 col-md-12 mt-1">
                    <div className='row'>
                        <div className="col-4 box-meter">
                            <ReactSpeedometer
                                maxValue={5000}
                                currentValueText={'Purchase: ${value}'}
                                value={memberships}
                                needleColor="red"
                                startColor="green"
                                segments={5}
...
//         try {
//             setIsLoading(true);
//             const response = await axios.get(`http://localhost:2000/api/membership?branchCode=${branchCode}`);
