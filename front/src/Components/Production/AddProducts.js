...
function NewProduction({ show, handleClose }) {
    ...
    const handleSchemeSubmit = async () => {
        try {
            const response = await fetch('https://www.empairindia.com/svv/addScheme', {
                method: 'POST',
                headers: {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post('https://www.empairindia.com/svv/addProducts', requestBody);
            toast.success('Products Added!!!')
